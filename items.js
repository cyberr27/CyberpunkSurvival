...
const ITEM_CONFIG = {
  ...
  // === ПОРВАННАЯ ЭКИПИРОВКА ЗДОРОВЬЯ ("Torn Health") ===
  torn_baseball_cap_of_health: {
    type: "headgear",
    effect: { armor: 5, health: 5 },
    description:
      "Порванная кепка здоровья: +5 к максимальному здоровью, +5 к броне",
    rarity: 4,
  ...
  // === ПОРВАННАЯ ЭКИПИРОВКА ЭНЕРГИИ ("Torn Energy") ===
  torn_energy_cap: {
    type: "headgear",
    effect: { armor: 5, energy: 5 },
    description:
  ...
  // === ПОРВАННАЯ ЭКИПИРОВКА ОБЖОРСТВА ("Torn Gluttony") ===
  ...
  // === ПОРВАННАЯ ЭКИПИРОВКА ЖАЖДЫ ("Torn Thirst") ===
  torn_cap_of_thirst: {
    type: "headgear",
