  ...
  const topics = [
    {
      ...
      text: "Слушай внимательно, человек… Было время, которое официально называют «техническим сбоем», но старожилы шепчутся — «Большое Отключение». Корпорации NeoCorp и ShadowTech решили зачистить всех, кто слишком глубоко ушёл в импланты и знал, как работает система изнутри. Миллионы людей с полным нейро-интерфейсом просто… выключили. Сердца останавливались, мозг превращался в кашу. Официально — «массовый сбой прошивки». А я уверен: моих родителей убили именно тогда. Нам с Джеком с детства врали, что они погибли «в аварии на нижнем уровне». Но я нашёл старый дата-чип матери — там логи подключения обрываются ровно в тот день. С тех пор я не верю ни одному слову корпораций. Мы все — вырощенные в обмане крысы в их лабораторном лабиринте.",
    },
    {
      title: "Сбор хабара",
      text: "Ты ведь бегаешь по уровням и пустошам, да? Запомни: баляры и редкие вещи падают не просто так. Обычная еда — орехи, яблоки, морковь — чаще всего в Неоновом Городе у мусорных баков и в заброшенных квартирах. Грибы и тушёнка любят токсичные джунгли — там влажность и тьма. Водка и энергетики — почти всегда в барах нижних уровней и в разбитых автоматах. А вот «атом» и хорошая броня — только в Пустошах и в редких сундуках верхних уровней, которые охраняют дроны корпораций. Главное правило: чем выше rarity предмета — тем реже он лежит на виду. И никогда не бери всё подряд — инвентарь кончается быстро, а вернуться за упущенным бывает уже нельзя. Умный собиратель всегда носит с собой пустые слоты под баляры и атомы — это валюта и броня будущего.",
    },
    {
      title: "Пустоши",
      text: "За стенами города — настоящая мясорубка. Там правят мутанты, скорпионы размером с собаку и радиационные бури, которые сдирают кожу за минуты. Но именно туда ходят самые отчаянные за «атомом» и старыми имплантами. Я сам один раз выходил с караваном — нас было шестеро. Нашли разбитый военный конвой, набитый ящиками с атомом. Обратно вернулось двое. Остальных забрали скорпионы ночью — эти твари чувствуют тепло тела даже через броню. С тех пор я в Пустоши не суйся без хорошего запаса антирада и хотя бы одного напарника. Там нет неона, нет правил, только песок, кости и шанс найти то, что сделает тебя богатым… или мертвым.",
    },
    {
      title: "Семья",
      text: "Родителей я почти не помню — только обрывки: мама в белом халате инженера, отец с датападом в руках. Потом их не стало, и нас с Джеком вырастили в приюте корпорации. Джек старше на три года — он всегда был хитрее, быстрее соображал, где взять еду и как не попасться патрулям. Когда мы выросли, он ушёл в контрабанду: водил караваны через Пустоши, знал все лазейки в стенах. Говорил: «Джон, ты чинишь железки, а я чиню судьбу». Сейчас он торгует тем, что я у людей скупаю по квестам — честный круговорот хабара в Неоновом Городе. Иногда я ему завидую: он свободен, как ветер в Пустошах. А я сижу здесь и пытаюсь хоть кому-то помочь выжить в этом аду. Но если честно… без Джека я бы давно свихнулся.",
    },
    {
      title: "Атом и броня",
      text: "Атом — это не просто валюта, это жизнь. Каждый кусочек «атома» можно вставить в броню или оружие — он даёт +5 брони за штуку и немного защищает от радиации. Чем больше атома в слотах экипировки — тем ты толще и живучее. Сейчас почти вся хорошая броня — nano_armor, cyber_pants, speed_boots — имеет специальные слоты под атом. Совет: держи хотя бы 10-15 атомов про запас, когда идёшь в Пустоши или на высокий уровень. А вообще — лучший комплект на данный момент: nano_armor + cyber_helmet + tactical_belt + speed_boots = около 60-70 брони + куча бонусов к энергии и здоровью. С таким сетом даже скорпион не сразу тебя порвёт.",
    },
    {
      title: "Корпорации",
      text: "NeoCorp и ShadowTech — две башни, что пронзают небо над городом. Там, наверху, воздух чистый, неон блестит так ярко, что глаза болят, а люди живут по 200 лет благодаря имплантам. Они обещают всем бессмертие… но цена — полная зависимость. Я сам когда-то работал инженером в лаборатории NeoCorp. Видел, как они сбрасывают токсичные отходы прямо в джунгли за стенами — дешевле, чем утилизировать. Из-за этого джунгли мутировали, а мы внизу дышим их дерьмом и дохнем от рака лёгких. Патрульные дроны отлавливают любого, кто слишком много знает. Один мой коллега нашёл доказательства, что Большое Отключение — не сбой, а плановая зачистка. На следующий день его нашли «повесившимся» в камере. Корпорации — это паразиты в блестящей обёртке. Пока мы дерёмся за баляры внизу, они пьют чистую воду и смеются.",
    },
  ];
