    ...
    switch (data.type) {
      ...
      case "update":
        ...
        if (data.player.id === myId) {
          ...
          setSelectedQuest(data.player.selectedQuestId || null); // Синхронизируем выбранное задание
          setAvailableQuests(data.player.availableQuests || []); // Синхронизируем доступные задания
