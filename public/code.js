...
createLight(950, 3115, "rgba(255, 0, 255, 0.4)", 750); // 4
createLight(50, 3120, "rgba(214, 211, 4, 0.5)", 700); // 5
createLight(264, 1173, "rgba(214, 211, 4, 0.4)", 900); // 6
createLight(2314, 2756, "rgb(194, 0, 10, 0.4)", 700); // 7
createLight(1605, 2151, "rgba(2, 35, 250, 0.4)", 800); // 8
createLight(3095, 2335, "rgb(28, 186, 55, 0.4)", 800); // 9
createLight(2605, 509, "rgba(2, 35, 250, 0.4)", 800); // 10
createLight(1083, 1426, "rgb(109, 240, 194, 0.4)", 650); // 11
createLight(2000, 900, "rgb(240, 109, 240, 0.4)", 750); // 12
createLight(133, 373, "rgb(240, 109, 240, 0.4)", 800); // 13
