...
window.corporateRobotSystem = (function () {
  ...
  const DIALOGUES = [
    // ... (текст диалогов не менял, но если нужно сократить для fit без скролла — дай знать)
    ...
    // (остальные диалоги аналогично, без изменений)
  ];
  ...
  function updateMovement(deltaTime) {
    ...
    const dist = Math.sqrt(distSq); // Кэшируем, чтобы не считать hypot дважды
